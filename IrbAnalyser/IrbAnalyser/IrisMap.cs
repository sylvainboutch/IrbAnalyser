        ...
        public static readonly Dictionary<string, string> siteMap = new Dictionary<string, string>()
            {
                ...
                {"NBHN_North Central Bronx Hospital","North Central Bronx"},
                {"NBHN_Child Health Center at Glebe Ave",""},
                {"NBHN_Health Center at Gunhill",""},
                {"NBHN_Health Center at Tremont",""},
        ...
        public static readonly Dictionary<string, string> roleMap = new Dictionary<string, string>()
            {
                { PI, OutputTeam.PI },
                { RC1, OutputTeam.RC },
                { RC2,OutputTeam.defaultDisabledRole},
                {"Additional Research service Coordinator",OutputTeam.defaultDisabledRole},
                {"Administrative Assistant",OutputTeam.defaultDisabledRole},
                {"Biostatistician",OutputTeam.defaultDisabledRole},
                {"Clinical Trials Coordinator",OutputTeam.defaultDisabledRole},
                {"Co-Investigator",OutputTeam.SubIno},
                {"Co-Principal Investigator",OutputTeam.SubIno},
                {"Department Administrator",OutputTeam.defaultDisabledRole},
                {"Nurse",OutputTeam.defaultDisabledRole},
                {"Other Faculty Collaborator",OutputTeam.defaultDisabledRole},
                {"Participating Clinician",OutputTeam.defaultDisabledRole},
                {"Postaward Coordinator",OutputTeam.defaultDisabledRole},
                {"Primary Research service Coordinator",OutputTeam.defaultDisabledRole},
                {"Research Associate",OutputTeam.defaultDisabledRole},
                {"Research Pharmacist",OutputTeam.defaultDisabledRole},
                {"Student Researcher",OutputTeam.defaultDisabledRole},
                {SC,OutputTeam.defaultDisabledRole},
                {"Study Author",OutputTeam.defaultDisabledRole},
                {"UNKNOWN ROLE - Migrated KP 1",OutputTeam.defaultDisabledRole},
                {"UNKNOWN ROLE - Migrated KP 2",OutputTeam.defaultDisabledRole},
                {"Other/Not Listed (explain)",OutputTeam.defaultDisabledRole},
                {"",OutputTeam.defaultDisabledRole}
